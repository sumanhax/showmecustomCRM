...
const ManageHat = () => {
    ...
    if (hatListData?.data && Array.isArray(hatListData.data)) {
      return hatListData.data.map((item) => {
        ...
        return {
          ...
          supplierStyleCode: item.supplierStyleCode || "",
  ...
  const columnDefs = [
    ...
    {
      field: "supplierStyleCode",
      headerName: "Supplier Style Code",
      sortable: true,
      filter: true,
      flex: 1,
    },
      ...
      <div className="wrapper_area my-0 mx-auto p-6 rounded-xl bg-white">
        ...
        {openDeleteModal && selectedHatData && (
          <DeleteConfirmModal
            ...
            supplierName={selectedHatData.hatName}
            itemType="hat"
          />
        )}
      </div>
