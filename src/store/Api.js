...
const formDataURL = ['/api/admin/hat/hat-images','/api/admin/hat/hat-images-update','/postgresapi/admin/hat/image/save','/postgresapi/admin/hat/primary-image/update'];
