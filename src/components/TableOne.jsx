import BrandOne from '../assets/imagesource/brand/brand-01.svg';
import BrandTwo from '../assets/imagesource/brand/brand-02.svg';
import BrandThree from '../assets/imagesource/brand/brand-03.svg';
import BrandFour from '../assets/imagesource/brand/brand-04.svg';
import BrandFive from '../assets/imagesource/brand/brand-05.svg';

const TableOne = () => {
  return (
    <div className="rounded-md shadow-md border border-stroke bg-white px-5 pt-6 pb-2.5 sm:px-7.5 xl:pb-1">
